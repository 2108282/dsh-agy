...
export const zh = {
  ...
  byAccount: '按账号',
  byAccountAside: '含限流与轮换 · Token 为四类合计',
  colModel: '模型',
  colInput: '输入',
  colOutput: '输出',
  colCacheRead: '缓存读',
...
export const en: Record<AgyLocaleKey, string> = {
  ...
  kpiCacheHit: '{percent}% hit · of prompt',
  ...
  byAccountAside: 'with rate limits and rotations · tokens summed over all four buckets',
  colModel: 'Model',
  colInput: 'Input',
  colOutput: 'Output',
