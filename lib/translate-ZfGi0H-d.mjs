...
import { v as generateAntigravityRequestId } from "./accounts-Cle7tmMg.mjs";
import { a as isLevelThinkingModel, i as isClaudeModel, o as resolveModelAlias } from "./catalog-DX6YaSY3.mjs";
...
function toAgyRequestBody(options, context) {
	...
	if (effort && isLevelThinkingModel(resolvedModel) && LEVEL_THINKING_LEVELS.has(effort)) generationConfig.thinkingConfig = {
...
//# sourceMappingURL=translate-ZfGi0H-d.mjs.map