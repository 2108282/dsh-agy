...
import { a as AGY_PLATFORM_ENUM, g as resolveAgyClientCredentials, h as getAgyBootstrapUserAgent, i as AGY_IDE_TYPE, l as OAUTH_TOKEN_URL, p as currentAgyVersion, r as AGY_ENDPOINT_FALLBACKS, u as OAUTH_USERINFO_URL } from "./constants-Db4tmyfb.mjs";
import { o as proxiedFetch } from "./proxy-DfaL73mL.mjs";
import { n as calculateTokenExpiry } from "./auth-DPPVFwio.mjs";
...
async function fetchWithTimeout(url, options, timeoutMs = FETCH_TIMEOUT_MS, proxyUrl) {
...
async function loadCodeAssist(accessToken, options = {}) {
	const errors = [];
	const loadHeaders = {
...
*/
async function exchangeAntigravity(code, state, redirectUri, expectedVerifier, routing = {}) {
	try {
...
//# sourceMappingURL=exchange-yZPIZumk.mjs.map