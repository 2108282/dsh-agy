import { d as isAgyDisabled, f as generateFingerprint, g as resolveAntigravityVersionBounded, n as maskProxyUrl, p as recordFingerprintVersion } from "../accounts-B4PZV8jq.mjs";
...
function createAgyWebRoutes(options) {
	...
	const handleModels = async (_req, res) => {
		...
		try {
			const { listAgyModels } = await import("../models-Dz2keK-1.mjs").then((n) => n.r);
