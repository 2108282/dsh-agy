import { i as normalizeProxyUrl, n as isProxyReachable, o as proxyUrlForLogs } from "../proxy-DLvX8yxv.mjs";
import { d as isAgyDisabled, f as generateFingerprint, h as resolveAntigravityVersionBounded, n as maskProxyUrl, p as recordFingerprintVersion } from "../accounts-wzH9KGR7.mjs";
import { t as createAgyRuntime } from "../plugin-common-CLXsvFaD.mjs";
import { t as exchangeAntigravity } from "../exchange-dQm2mjJ5.mjs";
import { n as upsertImportedAccount, r as authorizeAntigravity, t as importManySources } from "../import-B0-udX19.mjs";
...
function createAgyWebRoutes(options) {
	...
	const handleModels = async (_req, res) => {
		...
		try {
			const { listAgyModels } = await import("../models-BP9kYRcK.mjs").then((n) => n.r);
