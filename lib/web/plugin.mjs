import { d as isAgyDisabled, f as generateFingerprint, g as resolveAntigravityVersionBounded, n as maskProxyUrl, p as recordFingerprintVersion } from "../accounts-BqX7yYlW.mjs";
import { a as proxyUrlForLogs, r as normalizeProxyUrl, t as isProxyReachable } from "../proxy-DQPIwUov.mjs";
import { t as createAgyRuntime } from "../plugin-common-B-FQTDb5.mjs";
import { t as exchangeAntigravity } from "../exchange-BneHH_Dy.mjs";
import { n as upsertImportedAccount, r as authorizeAntigravity, t as importManySources } from "../import-DF7U3mp1.mjs";
...
function createAgyWebRoutes(options) {
	...
	const accountsList = async () => {
		...
		for (const entry of list) {
			...
			try {
				const { fetchAvailableModels } = await import("../models-9grwxR_1.mjs").then((n) => n.r);
	...
	const handleModels = async (_req, res) => {
		...
		try {
			const { listAgyModels } = await import("../models-9grwxR_1.mjs").then((n) => n.r);
