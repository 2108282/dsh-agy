import { a as deriveKey, c as resolveDshHome, d as isAgyDisabled, i as createAesGcmCodec, l as resolveMasterKeyCodec, n as maskProxyUrl, o as loadMasterKey, t as JsonAccountStore, u as AgySessionManager, y as AGY_DEFAULT_REDIRECT_URI } from "../accounts-B4PZV8jq.mjs";
import { r as normalizeProxyUrl, t as isProxyReachable } from "../proxy-DQPIwUov.mjs";
import { t as exchangeAntigravity } from "../exchange-VBRtzWVq.mjs";
import { n as upsertImportedAccount, r as authorizeAntigravity, t as importManySources } from "../import-W1PPfx1E.mjs";
...
async function statusCommand() {
	...
	for (const [index, account] of storage.accounts.entries()) {
		...
		if (session && session.index === index) try {
			const { fetchAvailableModels } = await import("../models-Dz2keK-1.mjs").then((n) => n.r);
